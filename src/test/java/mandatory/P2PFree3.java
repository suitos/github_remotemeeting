...
public class P2PFree3 {
	
	public static String SHARE_MESSAGE = "%s님이 %s를 공유했습니다.";
	...
	public void setUp(ITestContext context, String browsertype) throws Exception {
		...
		comm.login(attenddriver, CommonValues.USERS[0], CommonValues.USERPW);
		loginUserName = CommonValues.USERS[0].replace("@gmail.com", "");
	}
	
	// 1. 비로그인 유저 룸 생성 - 로그인 유저 참여
	@Test(priority = 1)
	public void freeRoomLoginAttend() throws Exception {
		String failMsg = "";
		...
		String roomcode = comm.findCode(driver).replace(" ", "");
		
		attenddriver.get(CommonValues.MEETING_URL + CommonValues.LOUNGE_URL);
		comm.attendRoomLoginUser(attenddriver, roomcode);
		wait_attend.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='dialog']")));
		
		String expected = "이 회의는 Free 버전으로 시작되었습니다.";
		if(!attenddriver.findElement(By.xpath("//div[@id='dialog']//span[@class='explain']")).getText().contentEquals(expected)) {
			failMsg = failMsg + "\n1. popup message [Expected]" + expected 
					+ " [Actual]" + attenddriver.findElement(By.xpath("//div[@id='dialog']//span[@class='explain']")).getText();
		}
	...
	public void freeRoomLock() throws Exception {
		String failMsg = "";
		...
		if(!msg.contentEquals(CommonValues.TOAST_FREELIMIT)) {
			failMsg = failMsg + "\n1. toast message [Expected]" + CommonValues.TOAST_FREELIMIT
					+ " [Actual]" + msg;
		}
	...
	public void freeRoomInvite() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_shareImg() throws Exception {
		String failMsg = "";
		...
		String expected = String.format(SHARE_MESSAGE, loginUserName, CommonValues.TESTFILE_LIST[3]);
	...
	public void freeRoom_shareTxt() throws Exception {
		String failMsg = "";
		...
		//타임라인 확인
		String timeline = comm.checkTimeline(attenddriver);
		String expected = String.format(SHARE_MESSAGE, loginUserName, CommonValues.TESTFILE_LIST[8]);
		if(!timeline.contentEquals(expected)) {
			failMsg = failMsg + "\n1. timeline message [Expected]" + expected + " [Actual]" + timeline;
		}
	...
	public void freeRoom_ShareScreen() throws Exception {
		String failMsg = "";
	...
	//7. 화면공유 종료
	@Test(priority = 7, dependsOnMethods = {"freeRoom_ShareScreen"}, alwaysRun = true,  enabled = true)
	public void freeRoom_StopScreen() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_ScreenShot() throws Exception {
		String failMsg = "";
		...
		String msg = attenddriver.findElement(By.xpath(CommonValues.XPATH_TOAST)).getText();
		if (!msg.contentEquals(CommonValues.TOAST_FREELIMIT)) {
			failMsg = failMsg + "\n1. toast message [Expected]" + CommonValues.TOAST_FREELIMIT + " [Actual]" + msg;
		}
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(CommonValues.XPATH_TOAST)));
	...
	public void freeRoom_Rec() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_AdminMode() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_splitMode() throws Exception {
		String failMsg = "";
		...
		//모드변경 레이어 확인
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(CommonValues.XPATH_SWITCHMODE_BOX)));
		
		//분할모드 클릭 (두번째 옵션)
		attenddriver.findElement(By.xpath(CommonValues.XPATH_SWITCHMODE_BOX + "//div[@class='options']/div[2]")).click();
		
		//적용하기 클릭
		attenddriver.findElement(By.xpath(CommonValues.XPATH_SWITCHMODE_BOX + "//button")).click();
		...
		// 타임라인 확인
		String timeline = comm.checkTimeline(attenddriver);
		String expected = loginUserName + "님이 분할 모드로 변경했습니다.";;
		if (!timeline.contentEquals(expected)) {
			failMsg = failMsg + "\n1. timeline message [Expected]" + expected + " [Actual]" + timeline;
		}
	...
	public void freeRoom_focusMode() throws Exception {
		String failMsg = "";
		...
		//강조모드 클릭 (세번째 옵션)
		attenddriver.findElement(By.xpath(CommonValues.XPATH_SWITCHMODE_BOX + "//div[@class='options']/div[3]")).click();
		...
		// 타임라인 확인
		String timeline = comm.checkTimeline(attenddriver);
		String expected = loginUserName + "님이 강조 모드로 변경했습니다.";;
		if (!timeline.contentEquals(expected)) {
			failMsg = failMsg + "\n1. timeline message [Expected]" + expected + " [Actual]" + timeline;
		}
	...
	public void freeRoom_speakerMode() throws Exception {
		String failMsg = "";
		...
		//주화자모드 클릭 (첫번째 옵션)
		attenddriver.findElement(By.xpath(CommonValues.XPATH_SWITCHMODE_BOX + "//div[@class='options']/div[1]")).click();
		...
		// 타임라인 확인
		String timeline = comm.checkTimeline(attenddriver);
		String expected = loginUserName + "님이 주화자 모드로 변경했습니다.";;
		if (!timeline.contentEquals(expected)) {
			failMsg = failMsg + "\n1. timeline message [Expected]" + expected + " [Actual]" + timeline;
		}
	...
	public void freeRoom_attendeesList() throws Exception {
		String failMsg = "";
		...
		if(userlist.size()!= 2) {
			...
			if(!userlist.get(0).findElement(By.xpath(".//span[@class='attendee-name']/span[2]")).getText().contains(CommonValues.FREENICKNAME)){
				failMsg = "\n1. attendlist username [Expected]" + CommonValues.ADMINNICKNAME
	...
	public void freeRoom_cam() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_mic() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_settingMic() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_settingSpeaker() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_note() throws Exception {
		String failMsg = "";
		...
		WebElement aitab = attenddriver.findElement(By.xpath("//ul[@class='wrap-tab-menu']/li[1]"));
		action.moveToElement(aitab).perform();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='tooltip-notice-option note-tooltip']")));
		String tooltip = attenddriver.findElement(By.xpath("//div[@class='tooltip-notice-option note-tooltip']")).getText();
		if(!tooltip.contentEquals(P2PFree.TOOLTIP_AITAB)) {
			failMsg = failMsg + "\n1. ai tab tooltip [Expected]" + P2PFree.TOOLTIP_AITAB + " [Actaul]" + tooltip;
		}
		
		action.moveToElement(attenddriver.findElement(By.xpath(CommonValues.XPATH_NOTE))).perform();
	...
	public void freeRoom_noteshare() throws Exception {
		String failMsg = "";
	...
	@Test(priority = 45, dependsOnMethods = {"freeRoom_noteshare"}, enabled = true)
	public void freeRoom_noteshare2() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_noteEsc() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_timeline() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_sendMsg() throws Exception {
		String failMsg = "";
	...
	public void freeRoom_leave() throws Exception {
		String failMsg = "";
		...
		Thread.sleep(2000);
		if(!driver.getCurrentUrl().contains(CommonValues.MEETING_URL + CommonValues.KRHOME_URL)) {
			failMsg = failMsg + "\n1.not home url after leave the room(free user) : " + driver.getCurrentUrl();
		}
		if(!attenddriver.getCurrentUrl().contains(CommonValues.MEETING_URL + CommonValues.LOUNGE_URL)) {
			failMsg = failMsg + "\n1.not lounge url after leave the room(login user) : " + attenddriver.getCurrentUrl();
		}
